package com.idle.authservice.infrastructure.authentication;
...
public class CustomUserDetails implements OAuth2User, OidcUser, UserDetails {
    ...
    public static CustomUserDetails create(UserSecurityForm user, Map<String, Object> attributes) {
    ...
    public static CustomUserDetails create(UserSecurityForm user) {
